...
def logging():
    ...
    list_output_command = run_configuration_across_ssh(type_error, dir_cfg, dir_command)
...
if __name__ == '__main__':
    ...
    with ssh_local_device(hostname=hostname, username=username,
        ...
        output_command = logging()

    module.exit_json(changed=False, msg=msg, output_command=output_command)